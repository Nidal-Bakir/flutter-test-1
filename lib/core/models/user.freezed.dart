...
abstract class $UserCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: 'id', required: true, nullable: false) int userId,
      @JsonKey(required: true, nullable: false) String name,
      @JsonKey(required: true, nullable: false) String email});
}
